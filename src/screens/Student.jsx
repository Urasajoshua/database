...
const StudentForm = () => {
    ...
    useEffect(() => {
        const fetchCourses = async () => {
            try {
                const response = await axios.get('http://gamerlastborn.pythonanywhere.com/auth/courses/');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('http://gamerlastborn.pythonanywhere.com/api/users/', { ...formData, password: defaultPassword,role:'STUDENT' });
